...
<body>
  ...
  <!--Recupération des données de la bdd pour afficher les valeurs à éditer-->
  <?php
  $product = $bdd->selectValueBddWhereMulti('*','products','id', $_SESSION['idProdModify']);
  $prodData = $product->fetch();
  $idPro = $_SESSION['idProdModify'];
    if (isset($idPro)) { $_SESSION['imgProduct'] = $prodData['img_adresse'] ; }
  ?>
            ...
            <div class="row d-flex justify-content-center">
                <div class=" ">
                    ...
                    <input value = "<?php if(isset($_SESSION['description_short'])){
                        ...
                        echo $prodData['description_short']; 
                    } ?>"
                    ...
                    <textarea
                     ...
                     <?php if(isset($_SESSION['description_long'])){
                        ...
                        echo $prodData['description_long']; } 
                    ?>
                    </textarea>
                    ...
                    <input
                     name= "img_adresse" 
                     value = "<?php if(isset($_SESSION['imgProduct'])){ 
                         echo $_SESSION['imgProduct']; 
                    } ?>"
                     type="text" class="form-control mb-4" readonly
                     >

                    <input  name = "update_product" 
                            type="submit" 
                            value="SOUMETTRE" 
  ...
  <div>
          ...
          <div class="row col-lg-4">
            <div class=" col-lg-12 d-flex align-items-center justify-content-center mt-3 ">
                <?php 
                if (isset($_SESSION['imgProduct'])) { ?>
                    <img    class ="border"
                            src="<?php echo $_SESSION['imgProduct']; ?>" 
