  ...
  <h1>
    ...
    <form action="router.gil.php" method="POST" class="needs-validation">
      ...
      <div class="form-group col-xs-12">
        ...
        <div class="col-xs-9">
          <input name="password" type="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$" required title="8 characters minimum" class="form-control" id="inputPassword3" placeholder="Enter your password" required>
          <div class="valid-feedback">
            Looks good!
          </div>
          <div class="text-danger">
      ...
      <div class="form-group col-xs-12">
        ...
        <div class="col-xs-8">
          <input name="passwordConfirmation" type="password" pattern=".{8,20}" required title="8 characters minimum" class="form-control" id="inputPassword3" placeholder="Confirm your password" required>
          <div class="valid-feedback">
            Looks good!
          </div>
          <div class="text-danger">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          <button name="submitInscription" type="submit" name="submit_inscription" class="btn btn-primary">Sign up</button>
        </div>
      </div>
    </form> 
