...
class Animal
{
    protected $_name; //donne le nom de l'objet animal
    protected $_legs; //donne le nombre patte de l'animal ne peut être inferieur a 4
    protected $_type; //donne le type d'animal ex : oiseau
    ...
    protected static $countAnimal = 0; // compte le nombre animal total
    protected static $countMammal = 0; // compte le nombre de mammal
    protected static $countFish   = 0; // compte le nombre de fish
    protected static $countBird   = 0; //compte le nombre oiseau
