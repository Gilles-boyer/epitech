...
/******************************************************************************
 * by gil le 21/06/20 the name function updateValueBdd($table,$champs,$id,$bdd)
 * this fontion return $print 
 * @param = $table = strind = name table
 * @param = $champs = string = list of champs
 * @param = $bdd = object bdd
 * @param = $array = array list of table;
 *****************************************************************************/
function updateValueBddWithId($table,$champs,$array,$bdd)
{
